...
public class SineDef extends CurveDef {

    protected final float baseY, peakY;

    public SineDef(float startX, float endX, float baseY, float peakY,
    ...
    public Vector2[] buildVertices() {
        return CurveVertexGenerator.createSineVertices(startX, endX, baseY, peakY, numSegments, scaleFactor);
    }
}